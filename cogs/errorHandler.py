...
def print_timestamp(text='', title='', mode=0, url=''):
    ...
    if mode == 0: # plain text with possible title
        print(f'[{TextColor.RED}{date}{TextColor.RESET}| {TextColor.PURPLE}{time}{TextColor.RESET}] {TextColor.RESET}{title}{TextColor.YELLOW}{text}{TextColor.RESET}\n', end='')
        process = subprocess.Popen('echo 0 > /sys/class/leds/working/brightness', stdout=subprocess.PIPE, shell=True)
    elif mode == 1: # error
        print(f'[{TextColor.RED}{date}{TextColor.RESET}| {TextColor.PURPLE}{time}{TextColor.RESET}] {TextColor.RED}{title}{TextColor.RESET}{text}\n', end='')
        ...
        print(f'[{TextColor.RED}{date}{TextColor.RESET}| {TextColor.PURPLE}{time}{TextColor.RESET}] {TextColor.RESET}{title}{TextColor.YELLOW}{hyperlink}\n', end='')
